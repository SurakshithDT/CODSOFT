...
class GUI():
    def __init__(self,master):
        ...
        self.label = Label(text="PASSWORD GENERATOR", anchor=N, fg='darkblue', bg='white', font='arial 20 bold italic')
        ...
        self.user = Label(text="User Name: ", font='times 15 bold', bg='white', fg='Black')
        ...
        self.length = Label(text="Password Length: ", font='times 15 bold', bg='white', fg='black')
        ...
        self.generated_password = Label(text="Generated Password: ", font='times 15 bold', bg='white', fg='darkblue')
        self.generated_password.grid(row=8, column=0)

        self.generated_password_textfield = Entry(textvariable=self.n_generatedpassword, font='times 15', bd=6, relief='ridge', fg='black')
        ...
        self.generate = Button(text="GENERATE PASSWORD", bd=3, relief='solid', padx=1, pady=1, font='Verdana", 15 bold', fg='black', bg='yellow', command=self.generate_pass)
        self.generate.grid(row=11, column=1)

        self.blank_label5 = Label(text="")
        self.blank_label5.grid(row=12, column=0)

        self.accept = Button(text="ACCEPT", bd=3, relief='solid', padx=1, pady=1, font='arial 15 bold italic', fg='white', bg='green', command=self.accept_fields)
        self.accept.grid(row=13, column=1)

        self.blank_label1 = Label(text="")
        self.blank_label1.grid(row=14, column=1)

        self.reset = Button(text="RESET", bd=3, relief='solid', padx=1, pady=1, font='arial 15 bold italic', fg='white', bg='red', command=self.reset_fields)
